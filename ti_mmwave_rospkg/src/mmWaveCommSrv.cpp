...
public:
    ...
    {
        this->declare_parameter("command_port", "default");
        this->declare_parameter("command_rate", "default");
    ...
    const std::shared_ptr<ti_mmwave_rospkg_msgs::srv::MmwaveCli::Response> response)
{
    ...
    mySerialObject.readline(response->resp, 1024, ":/>");
    RCLCPP_INFO(rclcpp::get_logger("rclcpp"),"mmWaveCommSrv: Received response from sensor: '%s' \nend of received response\n", response->resp.c_str());
