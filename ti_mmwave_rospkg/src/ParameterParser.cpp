...
public:
    ...
    {
        this->declare_parameter("device_name", "default_device_name"); //rclcpp::PARAMETER_STRING);
        this->declare_parameter("mmwavecli_name", "default_mmwavecli_name");//rclcpp::PARAMETER_STRING);
        this->declare_parameter("mmwavecli_cfg", "default_mmwavecli_cfg");//rclcpp::PARAMETER_STRING);
