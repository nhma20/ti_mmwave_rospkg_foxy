...
DataUARTHandlerNode::DataUARTHandlerNode() : Node("DataUARTHandlerNode")
{
    ...
    this->declare_parameter("data_port", "default");
    this->declare_parameter("data_rate", "default");
    this->declare_parameter("max_allowed_elevation_angle_deg", 0);
    this->declare_parameter("max_allowed_azimuth_angle_deg", 0);
    this->declare_parameter("frame_id", "default");
